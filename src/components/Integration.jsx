    ...
    <section className="py-20 bg-rub-lightGray">
      <div className="container mx-auto px-6 max-w-4xl text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          {/* Text/Content Side */}
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 min-h-[400px] flex items-center justify-center order-2 md:order-1">
                ...
                {activeTab === '1fach' ? (
                  <div className="flex flex-col items-center gap-6">
                    ...
                    <img 
                      ...
                      className="rounded-xl shadow-lg w-full max-w-full mt-4 border border-gray-100"
                    />
                  </div>
                ) : (
                  <div className="flex flex-col items-center gap-6">
          ...
          >
            <img 
              ...
              className="rounded-3xl shadow-2xl w-full h-full object-cover min-h-[300px] md:min-h-[400px]"
            />
          </motion.div>
        </div>
      </div>
